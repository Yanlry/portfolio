...
// Experience & Certification: auto-scroll ticker, pauses and becomes
// manually scrollable (wheel/trackpad) while the mouse is hovering it.
(function () {
	const container = document.getElementById("experience-scroll");
	if (!container) return;

	const speed = 0.3; // px per animation frame
	let paused = false;
